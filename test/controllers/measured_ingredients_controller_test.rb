...
class MeasuredIngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measured_ingredient" do
    assert_difference('MeasuredIngredient.count') do
      post measured_ingredients_url, params: { measured_ingredient: { amount: @measured_ingredient.amount, dish_id: @measured_ingredient.dish_id, ingredients_id: @measured_ingredient.ingredients_id, measurements_id: @measured_ingredient.measurements_id } }
    end
  ...
  test "should update measured_ingredient" do
    patch measured_ingredient_url(@measured_ingredient), params: { measured_ingredient: { amount: @measured_ingredient.amount, dish_id: @measured_ingredient.dish_id, ingredients_id: @measured_ingredient.ingredients_id, measurements_id: @measured_ingredient.measurements_id } }
